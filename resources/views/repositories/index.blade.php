                    ...
                    <tbody>
                        @forelse ($repositories as $repository)
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    <a href="{{ route('repositories.show', $repository) }}" class="px-4 rounded-md bg-blue-500 text-white">Ver</a>
                                </td>

                                <td class="px-4 py-2">
                                    <a href="{{ route('repositories.edit', $repository) }}" class="px-4 rounded-md bg-blue-500 text-white">Editar</a>
                                </td>
